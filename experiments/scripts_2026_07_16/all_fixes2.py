"""Phase 2: intl + DM test (companion to all_fixes.py)."""
import numpy as np
import pandas as pd
import json, os
import torch
...
# International with Transformer (adjusted splits for intl data)
print("=== International with Transformer (adjusted splits) ===", flush=True)
